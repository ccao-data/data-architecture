...
cct_as_cofe_dtl <- map_dfr(files_cct_as_cofe_dtl$Key, \(f) {
  aws.s3::s3read_using(
    ...
    col_positions = readr::fwf_cols(
      ...
      tax_rate = c(43, 51),
      amount_due = c(53, 65),
      amount_due_sg = c(67, 67),
      amount_paid = c(69, 81),
      amount_paid_sg = c(83, 83),
      ...
      adjudication_date = c(425, 432),
      amendment_number = c(434, 436),
      amendment_date = c(438, 445),
      update_date = c(447, 454),
      update_id = c(456, 463),
      refund_date = c(465, 472),
      account_number = c(474, 476),
      d_o_number = c(478, 484),
      excess_valuation = c(486, 498),
      amount_of_credit = c(500, 512),
      ty_jrcr_sg = c(514, 514),
      refund_amount = c(516, 528),
      ty_rfnd_sg = c(530, 530),
      interest_date = c(532, 537),
      ...
      ty_int_amt_sg = c(612, 612),
      ty_rsf_resp = c(614, 614),
      rsf_value = c(616, 624),
      action_issue_date = c(626, 633),
      track_date = c(635, 642),
      tracking_disposition = c(644, 645),
      certified_sen_freeze_response = c(647, 647),
      # TODO: Whats going on with these fields?
      certified_land_valuation = c(649, 657),
      certified_building_valuation = c(659, 667),
      recommended_land_valuation = c(649, 657),
      recommended_building_valuation = c(659, 667),
      certified_exe_freeze_valuation = c(689, 697),
      interest_date = c(699, 706),
      check_date = c(708, 715),
      check_number = c(717, 723),
      certified_home_av = c(725, 733),
      treasurer_tracking_date = c(735, 742),
      ...
      ty_cho_resp = c(776, 776),
      ty_chs_resp = c(778, 778),
    ...
    col_types = cols(
      ...
      amount_due_sg = col_character(),
      amount_paid = col_integer(),
      amount_paid_sg = col_character(),
      applicant_name = col_character(),
      applicant_address = col_character(),
      city = col_character(),
      state = col_character(),
      ...
      secondary_applicant_name = col_character(),
      ...
      recommended_1977_homeowner_base_value = col_integer(),
      recommended_exe_homeowner_proration = col_double(),
      ...
      ty_int_amt_sg = col_character(),
      ty_rsf_resp = col_character(),
      rsf_value = col_integer(),
      action_issue_date = col_character(),
      track_date = col_character(),
      tracking_disposition = col_character(),
      certified_sen_freeze_response = col_character(),
      certified_land_valuation = col_integer(),
      certified_building_valuation = col_integer(),
      recommended_land_valuation = col_integer(),
      recommended_building_valuation = col_integer(),
      certified_exe_freeze_valuation = col_integer(),
      interest_date = col_character(),
      check_date = col_character(),
      check_number = col_character(),
      certified_home_av = col_integer(),
      treasurer_tracking_date = col_character(),
      certified_exe_vetdis = col_integer(),
      recommended_exe_vetdis = col_integer(),
      certified_exe_homeowner_proration = col_double(),
      certified_exe_homeowner_coop_qty = col_integer(),
      certified_exe_homeowner_occ_factor = col_double(),
      ty_cho_resp = col_character(),
      ty_chs_resp = col_character(),

...
data.frame(
  ...
  "2010" = c(51.0, 68.2, 65.7, 72.6, 58.9, 61.2, 62.9, 45.0, (59.3 + 56.4) / 2, 54.7, 52.1, 58.2, NA),
  "2011" = c(51.5, 69.2, 65.3, 68.7, 59.4, 62.9, 62.5, 46.0, 61.3, 54.4, 49.0, 58.9, NA),
  "2012" = c(51.3, 68.5, 65.5, 71.0, 60.5, 63.3, 62.8, 46.7, 59.9, 54.4, 48.3, 57.4, NA),
  "2013" = c(51.3, 68.5, 65.5, 71.0, 60.5, 63.3, 62.8, 46.7, 59.9, 54.4, 48.3, 57.4, NA),
  "2014" = c(53.2, 70.0, 65.2, 67.2, 62.3, 64.8, 62.0, 52.7, 59.9, 54.9, 51.4, 58.2, NA),
  "2015" = c(55.0, 70.6, 66.2, 74.1, 63.5, 70.9, 63.1, 53.5, 61.1, 52.6, 51.7, 62.1, (60.5 + 63.0) / 2),
  "2016" = c(54.7, 71.2, 67.4, 73.4, 55.2, 70.2, 63.4, 54.9, 61.0, 55.3, 54.9, 58.8, 61.2),
  "2017" = c(55.4, 71.2, 66.8, 73.0, 55.6, 70.2, 62.9, 55.1, 60.3, 55.9, 54.4, 59.0, 61.3),
  "2018" = c(55.1, 70.8, 65.5, 73.6, 55.2, 70.0, 60.9, 54.4, 61.2, 55.2, 53.2, 59.7, 60.6),

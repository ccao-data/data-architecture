...
SELECT
    ...
    CAST(COALESCE(vrc.char_yrblt, vcr.char_yrblt) AS INT) AS year_built,
    CAST(vrc.char_bldg_sf AS INT) AS bldg_sf,
    CAST(vrc.char_land_sf AS INT) AS land_sf,
    vcr.char_unit_sf AS unit_sf,
    CAST(COALESCE(vrc.char_fbath, vcr.char_full_baths) AS INT) AS full_baths,
    CAST(COALESCE(vrc.char_hbath, vcr.char_half_baths) AS INT) AS half_baths,
    CAST(COALESCE(vrc.char_beds, vcr.char_bedrooms) AS INT) AS bedrooms,

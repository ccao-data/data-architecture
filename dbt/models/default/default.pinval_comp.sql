...
comp_with_training_chars AS (
    SELECT
        ...
        CAST(CAST(t.meta_sale_price / 1000 AS BIGINT) AS VARCHAR)
        ...
        t.prox_nearest_road_arterial_daily_traffic,
        t.prox_nearest_road_collector_daily_traffic,
        t.prox_nearest_new_construction_dist_ft,
        t.prox_nearest_stadium_dist_ft,
        ...
        t.shp_parcel_centroid_dist_ft_sd,
        t.shp_parcel_edge_len_ft_sd,

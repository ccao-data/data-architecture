...
SELECT
    ...
    cnt_pin_num_school.num_school_in_half_mile,
    cnt_pin_num_school.num_school_with_rating_in_half_mile,
    cnt_pin_num_school.avg_school_rating_in_half_mile,
...
LEFT JOIN
    ...
    AND pin.year = dist_pin_to_stadium.year
LEFT JOIN

...
WITH uni AS (
    SELECT
        ...
        vpsi.prox_nearest_arterial_road_daily_traffic,
        vpsi.prox_nearest_arterial_road_dist_ft,
        vpsi.prox_nearest_arterial_road_lanes,
        vpsi.prox_nearest_arterial_road_speed_limit,
        vpsi.prox_nearest_arterial_road_surface_type,
        vpsi.prox_nearest_bike_trail_dist_ft,
        vpsi.prox_nearest_cemetery_dist_ft,
        vpsi.prox_nearest_collector_road_daily_traffic,
        vpsi.prox_nearest_collector_road_dist_ft,
        vpsi.prox_nearest_collector_road_lanes,
        vpsi.prox_nearest_collector_road_speed_limit,
        vpsi.prox_nearest_collector_road_surface_type,
        ...
        vpsi.prox_nearest_highway_road_dist_ft,
        vpsi.prox_nearest_highway_road_lanes,
        vpsi.prox_nearest_highway_road_speed_limit,
        vpsi.prox_nearest_highway_road_surface_type,

...
SELECT
    oby_change.parid AS "PARID",
    oby_change.taxyr AS "TAXYR",
    asmt.township_code AS "TOWNSHIP",
    asmt.class AS "CLASS",
    asmt.own1 AS "OWN1",
    asmt.reascd AS "Reason for Change",
    asmt.who AS "WHO",
    oby_change.card AS "CARD",
    oby_change.lline AS "LLINE",
    oby_change.chgrsn AS "Card Code",
    oby_change.external_occpct_prev AS "Prior Year Occupancy %",
    oby_change.external_occpct AS "Curr. Year Occupancy %",
    oby_change.pct_prev_of_cur_adjrcnld AS "Prior Year % of Curr. Year",
    oby_change.difference_in_pct AS "Difference in %",
    oby_change.adjrcnld_prev AS "Prior Year OBY VAL",
    oby_change.adjrcnld AS "Curr. Year OBY VAL",

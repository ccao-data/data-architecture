...
SELECT
    comdat_change.parid AS "PARID",
    comdat_change.taxyr AS "TAXYR",
    asmt.township_code AS "TOWNSHIP",
    asmt.class AS "CLASS",
    asmt.own1 AS "OWN1",
    asmt.reascd AS "Reason for Change",
    asmt.who AS "WHO",
    comdat_change.card AS "CARD",
    comdat_change.chgrsn AS "Card Code",
    comdat_change.external_occpct_prev AS "Prior Year Occupancy %",
    comdat_change.external_occpct AS "Curr. Year Occupancy %",
    comdat_change.pct_prev_of_cur_bldgval AS "Prior Year % of Curr. Year",
    comdat_change.difference_in_pct AS "Difference in %",
    comdat_change.bldgval_prev AS "Prior Year COMDAT VAL",
    comdat_change.bldgval AS "Curr. Year COMDAT VAL",

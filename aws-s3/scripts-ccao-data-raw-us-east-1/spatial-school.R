...
sources_list <- bind_rows(list(
  ...
  "locations_chi_0607" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "q9v3-hxbp?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2006-2007"
  ),
  "locations_chi_0708" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "x9yh-x8zu?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2007-2008"
  ),
  "locations_chi_0809" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "9p4q-n8rz?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2008-2009"
  ),
  "locations_chi_0910" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "qsgm-ub2r?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2009-2010"
  ),
  "locations_chi_1011" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "cvn9-pbt9?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2010-2011"
  ),
  "locations_chi_1112" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "6qik-a75t?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2011-2012"
  ),
  "locations_chi_1213" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "56cp-u89f?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2012-2013"
  ),
  "locations_chi_1314" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "grmh-ksdn?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2013-2014"
  ),
  "locations_chi_1415" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "3fhj-xtn5?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2014-2015"
  ),
  "locations_chi_1516" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "2mts-wp7t?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2015-2016"
  ),
  "locations_chi_1617" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "9zky-nrsy?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2016-2017"
  ),
  "locations_chi_1718" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "4g38-vs8v?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2017-2018"
  ),
  "locations_chi_1819" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "8vyn-k2j3?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2018-2019"
  ),
  "locations_chi_1920" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "tz49-n8ze?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2019-2020"
  ),
  "locations_chi_2021" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "p83k-txqt?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2020-2021"
  ),
  "locations_chi_2122" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "vfmh-nkyk?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2021-2022"
  ),
  "locations_chi_2223" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "gqgn-ekwj?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2022-2023"
  ),
  "locations_chi_2324" = c(
    "source" = "https://data.cityofchicago.org/api/geospatial/",
    "api_url" = "mv87-m4mi?method=export&format=GeoJSON",
    "boundary" = "location",
    "year" = "2023-2024"
  )
))

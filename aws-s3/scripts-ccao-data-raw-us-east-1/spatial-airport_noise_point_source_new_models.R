...
airport_clean$added_intensity <- decibel_to_intensity(airport_clean$noise -
                                                        BASELINE_DNL)
...
airport_recent$added_intensity <- decibel_to_intensity(airport_recent$noise -
                                                         BASELINE_DNL)
...
airport_19$added_intensity <- decibel_to_intensity(airport_19$noise -
                                                     BASELINE_DNL)
...
airport_all$distance_ohare <- st_distance(airport_all$geometry,
                                          aps$geometry[1])
airport_all$distance_midway <- st_distance(airport_all$geometry,
                                           aps$geometry[2])
...
airport_all$added_intensity <- decibel_to_intensity(airport_all$noise -
                                                      BASELINE_DNL)
...
airport_all_factor$distance_ohare <- st_distance(airport_all_factor$geometry,
                                                 aps$geometry[1])
airport_all_factor$distance_midway <- st_distance(airport_all_factor$geometry,
                                                  aps$geometry[2])
...
ohare_model3_intensity <- lm(added_intensity ~
                               0 +
                                 isq_dist_ohare +
                                 factor(year),
...
midway_model3_intensity <- lm(added_intensity ~
                                0 +
                                  isq_dist_midway +
                                  factor(year),
                              data = airport_all_factor %>%

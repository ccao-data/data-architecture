...
parcel_shp_df_no_osm_file = parcel_shp_df_no_osm.loc[
...
parcel_shp_fil = parcel_shp_df_no_osm_file[["geometry", "pin10"]].rename(
    columns={"pin10": "id"}
)
osm_df_concat = pd.DataFrame(osm_df_concat).merge(
    osm_df[["id", "geometry"]], on="id", how="left"
)

...
, (BOR.LANDVAL + BOR.BLDGVAL)*10 AS [BOR RESULT]
...
(SELECT UNIVERSE.PIN, UNIVERSE.TAX_YEAR + 1 AS YEAR, fitted_value_1 AS [MODEL RESULT], fitted_value_6 AS [PIPELINE RESULT], CASE WHEN UNIVERSE.version IS NULL THEN 0 ELSE UNIVERSE.version END as VERSION

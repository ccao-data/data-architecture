...
SELECT SALES.PIN, sale_price, sale_date, DATE_A_ROLL_CERTIFIED, BOARD_CLOSE_DATE, FMV, FMV / sale_price AS RATIO, HEAD.TAX_YEAR, HEAD.TOWN_CODE, NBHD, [modeling_group]

FROM VW_CLEAN_IDORSALES AS SALES

LEFT JOIN

(SELECT PIN, LEFT(HD_TOWN, 2) AS TOWN_CODE, CAST(HD_NBHD AS varchar) AS NBHD, TAX_YEAR, (HD_ASS_LND + HD_ASS_BLD) * 10 AS FMV,

--Imports CCRD Transfer File data from Common drive into a ccrdsales data table, be sure to clean the data first in Excel, e.g. Remove trailing zipcodes, commas in unit no, 

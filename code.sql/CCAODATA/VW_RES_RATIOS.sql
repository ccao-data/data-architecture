...
WHERE (1=1)
	/* SOP 3.5.1 */
	AND ((NULLIF(PRIO_YEAR_SALE.sale_price,0) > 10000 
		AND PRIO_YEAR_SALE.sale_price IS NOT NULL) 
		OR
...
) AS AA WHERE [DEED NUMBER] IS NOT NULL AND NULLIF([SALE PRICE],0) >10000
GO

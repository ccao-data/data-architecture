...
#
# Requires Python dependencies be installed from
...
#   3. The output filename with which the .zip file should be written
#     * If not present, defaults to './test_failures.zip'
#
...
class FailedTest:
    ...
    # Column names for rows in the failed test output
    fieldnames: typing.List
    # Row values representing the failed test output
    failed_rows: typing.Tuple

    def get_name(self) -> str:
        """Get a canonical name for this test"""
...
class FailedTestWorkbook:
    ...
    def add_sheet(self, failed_test: FailedTest) -> None:
        ...
        self._set_sheet_title(sheet, failed_test.get_name())

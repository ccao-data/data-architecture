WITH mydec_cte AS (
    SELECT
        ...
        COUNT(CASE WHEN line_11_full_consideration < 10000 THEN 1 END)
            AS price_less_than_10k_count,
        COUNT(CASE WHEN line_11_full_consideration > 1000000 THEN 1 END)
...
SELECT
    ...
    CASE
        WHEN
            prev_year_price_less_than_10k_count IS NOT NULL

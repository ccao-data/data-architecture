/**
View containing cleaned, filled data for residential modeling. Missing data
is filled forward in time then backwards per PIN. The LAST_VALUE window
functions fill backward

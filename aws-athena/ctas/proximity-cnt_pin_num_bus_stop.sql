...
WITH (
    ...
    external_location='s3://ccao-data-warehouse-us-east-1/proximity/cnt_pin_num_bus_stop',
    ...
    xy_stop_counts AS (
        SELECT
            ...
            y_3435,
            year,
            COUNT(*) AS num_stops_in_half_mile
        FROM stop_buffers
    ...
    SELECT
        p.pin10,
        CASE
            WHEN xy.num_stops_in_half_mile IS NULL THEN 0
